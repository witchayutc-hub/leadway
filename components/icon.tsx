...
export default function Icon({
  ...
  const icons = {
    ...
    call: (
      <svg viewBox="-2 -2 24 24" fill={fill}>
        <g
          id="Page-1"
          stroke="none"
          strokeWidth="1"
    ...
    email: (
      <svg viewBox="-2 0 28 24" fill={fill}>
    ...
    line: (
      <svg viewBox="-8 0 80 64" fill={fill}>
        <path
          d="M64 27.487c0-14.32-14.355-25.97-32-25.97S0 13.168 0 27.487c0 12.837 11.384 23.588 26.762 25.62 1.042.225 2.46.688 2.82 1.578.322.81.21 2.076.103 2.894l-.457 2.74c-.14.81-.643 3.164 2.772 1.725s18.428-10.852 25.143-18.58C61.78 38.38 64 33.218 64 27.487"
          fill={fill}
        />
        <g fill="#ecb51d">
          <path d="M25.498 20.568h-2.245c-.344 0-.623.28-.623.623v13.943a.62.62 0 0 0 .623.62h2.245a.62.62 0 0 0 .623-.62V21.2c0-.343-.28-.623-.623-.623" />
          <path d="M40.948 20.558h-2.244c-.345 0-.624.28-.624.623v8.284l-6.4-8.63a.6.6 0 0 0-.158-.154.62.62 0 0 0-.168-.022h-2.244c-.344 0-.623.28-.623.623V35.13c0 .344.28.62.623.62h2.244c.344 0 .624-.278.624-.62v-8.28l6.397 8.64a.62.62 0 0 0 .168.022h2.244c.344 0 .623-.28.623-.62V21.2c0-.343-.28-.623-.623-.623" />
          <path d="M20.087 32.264h-6.1V21.2c0-.344-.28-.623-.623-.623H11.12c-.344 0-.623.28-.623.623v13.942c0 .344.28.62.623.62h8.968c.344 0 .623-.28.623-.623v-2.245c0-.344-.278-.623-.623-.623" />
          <path d="M53.345 24.06c.344 0 .623-.28.623-.623V21.2c0-.344-.278-.623-.623-.623h-8.968a.62.62 0 0 0-.623.623v13.943c0 .344.28.62.623.62h8.968c.344 0 .623-.28.623-.623v-2.246c0-.344-.278-.623-.623-.623h-6.098v-2.357h6.098c.344 0 .623-.28.623-.623V27.04c0-.344-.278-.624-.623-.624h-6.098V24.06h6.098z" />
        </g>
      </svg>
    ),
    home: (
    ...
    contact: (
      <svg
        ...
        width="29.873"
        height="33.962"
        viewBox="0 0 29.873 33.962"
      >
        <path
          id="Path_1396"
          data-name="Path 1396"
          d="M84.54,145.623a7.739,7.739,0,0,1-1.349-.591,2.884,2.884,0,0,1-1.125-3.19,3,3,0,0,1,2.6-2.18,2.947,2.947,0,0,1,2.938,1.693.429.429,0,0,0,.465.294c1.559-.013,3.117,0,4.676-.007a3.041,3.041,0,0,0,3.134-3.109c.006-.96,0-1.921,0-2.9H93.907v1.941H91.926V123.684h1.952v1.95h2c.155-4.269-1.349-7.77-4.943-10.135a10.262,10.262,0,0,0-11.69-.2c-3.8,2.327-5.407,5.906-5.258,10.355h1.978v-1.969h1.987v13.886h-1.97V135.6c-1.017,0-2,.007-2.979,0a2.924,2.924,0,0,1-2.207-.973,2.84,2.84,0,0,1-.783-1.954c-.012-1.37-.03-2.742,0-4.112a2.863,2.863,0,0,1,1.671-2.591c.1-.051.2-.1.364-.174,0-.726-.055-1.481.009-2.226a12.686,12.686,0,0,1,4.832-9.066,12.511,12.511,0,0,1,8.649-2.835A13.021,13.021,0,0,1,97.54,121.731a15.152,15.152,0,0,1,.329,3.786.409.409,0,0,0,.275.443,2.877,2.877,0,0,1,1.715,2.695q.03,1.974,0,3.947a2.885,2.885,0,0,1-1.742,2.712.365.365,0,0,0-.248.393c.011.951.008,1.9,0,2.852a5.032,5.032,0,0,1-5.071,5.073q-2.388,0-4.776,0c-.175,0-.291.015-.381.213a2.912,2.912,0,0,1-2.1,1.714.815.815,0,0,0-.145.065Z"
          transform="translate(-70.001 -111.661)"
          fill="#ecb51d"
        />
      </svg>
    ),
    city: (
      <svg viewBox="0 0 50 50" fill={fill}>
    ...
    star: (
      <svg viewBox="0 0 576 512" fill={fill}>
        <path
          fill={fill}
    ...
    loading: (
      <svg stroke={fill} viewBox="0 0 24 24">
        <g>
          <circle
            cx="12"
            cy="12"
